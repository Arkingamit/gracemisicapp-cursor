        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="leading-relaxed">
                For questions, support, or feedback, please reach out to the team:
              </p>
              <div className="bg-accent/50 p-4 rounded-lg border border-border space-y-4">
                <div>
                  <h3 className="font-semibold text-lg mb-1">Arkin Gamit</h3>
                  <p className="text-muted-foreground text-sm">Lead Developer</p>
                </div>
                <div>
                  <h3 className="font-semibold text-lg mb-1">Shine Gamit</h3>
